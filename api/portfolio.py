...
def close_position_endpoint(position_id: int, body: PositionCloseBody):
    ...
    sell_ced_usd = (
        body.sell_price_cedear_usd
        if body.sell_price_cedear_usd is not None
        else snap.get("sell_price_cedear_usd")
    )
    sell_usa = body.sell_price_usa if body.sell_price_usa is not None else snap.get("sell_price_usa")
    ...
    ok = close_position_row(
        ...
        sell_price_cedear_usd=sell_ced_usd,
        sell_price_usa=sell_usa,
        sell_gap=sell_gap,
