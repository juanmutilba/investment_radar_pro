...
def _row(underlying: str) -> None:
    ...
    spot, src, sym_used = resolve_option_chain_spot(underlying)
    ...
    print(f"  resolve_option_chain_spot    = spot={spot!r} spot_source={src!r} spot_symbol={sym_used!r}", flush=True)
    print("", flush=True)
